...
driver.get("https://www.linkedin.com/jobs/search/?currentJobId=3939432016&f_TPR=r604800&keywords=data%20analyst&origin=JOB_SEARCH_PAGE_JOB_FILTER&refresh=true&sortBy=R&spellCorrectionEnabled=true")
...
with pd.ExcelWriter('linkedin20.xlsx') as writer:#,mode='a',engine='openpyxl',if_sheet_exists='replace'
    #i=7
